...
class CustomerMovementExport implements FromCollection, WithHeadings, WithMapping, WithEvents
{
    ...
    protected CustomerLedgerReportService $service;
    ...
    public function __construct(
        ...
        $this->service = app(CustomerLedgerReportService::class);
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) use ($rtlEvents): void {
                ...
                $infoRows = [
                    4 => 'كشف حساب الزبون : '.Utf8Text::clean($this->customerName),
