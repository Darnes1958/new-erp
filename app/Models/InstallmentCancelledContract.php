...
class InstallmentCancelledContract extends CompanyModel
{
    protected $table = 'installment_contracts_cancelled';
    ...
    {
        return $this->hasMany(InstallmentCancelledDeduction::class, 'installment_contract_id');
    }
