...
namespace App\Filament\Ins\Resources\InstallmentCancelledContracts\Schemas;

use Filament\Infolists\Components\TextEntry;
use Filament\Schemas\Components\Section;
use Filament\Schemas\Schema;

class InstallmentCancelledContractInfolist
{
    public static function configure(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('بيانات العقد الملغي')->schema([
                ...
                TextEntry::make('cancelled_at')->label('تاريخ الإلغاء')->date(),
