...
class CustomerReceiptsSummaryTableWidget extends BaseDailyMovementTableWidget
{
    public function table(Table $table): Table
    {
        ...
        return $this->configureTable($table, 'transaction_kind', 'asc')
            ->query(fn () => $service->customerReceiptsSummary($this->dateFrom, $this->dateTo, $this->warehouseId))
