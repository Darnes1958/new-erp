...
namespace App\Filament\Market\Resources\SalesOfferInvoices\Schemas;
...
class SalesOfferInvoiceInfolist
{
    public static function configure(Schema $schema): Schema
    {
        ...
        return $schema->components([
            Section::make('بيانات فاتورة العرض')->schema([
                ...
                TextEntry::make('rate_markup')->label('النسبة %')->numeric(3),
